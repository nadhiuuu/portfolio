  ...
  return (
    <section id="contact" className="scroll-mt-20 py-20">
          <div className="mb-10 flex flex-col items-center text-center">
            <div className="font-sans mb-3 flex items-center gap-2 rounded-full bg-purple-50 px-4 py-1.5 text-sm font-medium text-purple-600 dark:bg-purple-900/20 dark:text-purple-400">
            ...
            <p className="font-sans mt-4 max-w-2xl text-sm sm:text-base text-zinc-600 dark:text-zinc-400">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            >
              ...
              <div className="min-w-0">
                <h3 className="font-sans text-sm font-medium text-zinc-500 dark:text-zinc-400">
                  Email Me
                </h3>
                <p className="font-sans truncate text-base sm:text-lg font-bold text-zinc-800 dark:text-zinc-100">
