        ...
        <div className="flex flex-col text-center md:text-left">
          ...
          <div className="opacity-0 mt-5 flex justify-center md:justify-start gap-4 animate-[fadeUp_0.8s_ease-out_0.55s_forwards]">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-zinc-900 px-6 py-2.5 text-sm font-medium text-white transition-all hover:bg-purple-600 active:scale-95 dark:bg-white dark:text-black dark:hover:bg-purple-400"
            >
